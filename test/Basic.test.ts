...
describe("Basic", () => {
  ...
  beforeEach(async () => {
    basic = (await deployContract(admin, BasicArtifact, [initName, initBalance])) as Basic;
  });
  ...
  it("test", async () => {
    ...
    await expect(basic.updateInfoPayable(afterName2, afterBalance2, { value: BigNumber.from(1) }))
